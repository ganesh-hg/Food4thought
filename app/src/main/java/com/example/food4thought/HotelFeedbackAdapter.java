...
public class HotelFeedbackAdapter extends RecyclerView.Adapter<HotelFeedbackAdapter.ViewHolder> {

    ArrayList<Hotelfeed> mList;
    Context context;

    public HotelFeedbackAdapter(ArrayList<Hotelfeed> mList, Context context) {
        this.mList = mList;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new HotelFeedbackAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Hotelfeed vacancy1 = mList.get(position);
